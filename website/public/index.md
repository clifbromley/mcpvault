...
- **v0.11.3 (April 2026):** File access validation improvements: dotfiles and extension-less paths are now consistently filtered, and ignore-pattern handling is more reliable across edge-case inputs.
